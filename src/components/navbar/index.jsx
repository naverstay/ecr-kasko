...
class Navbar extends Component {
    ...
    state = {width: window.innerWidth, mobSearch: false, mobFilter: false};

    toggleMobileSearch = () => {
        let action = !this.state.mobSearch ? 'add' : 'remove';
        this.setState({mobSearch: !this.state.mobSearch});
        document.getElementById('root').classList[action]('show-mobile-search');
    }

    toggleMobileFilter = () => {
        let action = !this.state.mobFilter ? 'add' : 'remove';
        this.setState({mobFilter: !this.state.mobFilter});
        document.getElementById('root').classList[action]('show-mobile-filter');
    }
            ...
            <>
                <div className="sidebar">
                    <div className="sidebar__header">
                        <div className="sidebar__button-wrapper sidebar__search-mobile">
                            <div className="sidebar__button __home label-nohover dt-only">
                                                ...
                                                <div className="lang-select__control css-yk16xz-control">
                                                    <div
                                                        ...
                                                        <div className="css-b8ldur-Input">
                                                            <div className="lang-select__input"><input
                                                                autoCapitalize="none"
                                                                autoComplete="off"
                                                                autoCorrect="off"
                            ...
                            <div className="sidebar__button active button-submenu dt-only">
                            ...
                            <div className="sidebar__button label-nohover">
                                <div className="sidebar__button-icon search dt-only"></div>
                                <div className="sidebar__button-label">
                                    <div className="sidebar__search">
                                        ...
                                        <div className="sidebar__search-form"><input className="sidebar__search-input"
                                            ...
                                            <button className="sidebar__search-button dt-only"></button>
                                        </div>
                                        <p className="sidebar__search-tip">Поиск по имени, фамилии<br/>или номеру
                                            телефона
                                        </p></div>
                                </div>
                            </div>
                            ...
                            <div className="sidebar__button button-submenu">
                                ...
                                <div className="sidebar__button-label">
                                    <div className="sidebar__user">
                                        ...
                                        <div className="sidebar__user-role dt-only">Менеджер по продажам<br/>ДЦ Дружба
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="sidebar__header-line">
                        <div className="sidebar__header-mobile">
                            ...
                            }} className="sidebar__header-back dt-hidden">Назад
                            </div>
                            <div className="sidebar__header-title dt-hidden">Заявки</div>
                            <div className="sidebar__header-mobile_controls dt-hidden">
                                <div onClick={() => {
                                    this.toggleMobileSearch()
                                }} className="sidebar__header-mobile_btn __search"/>
                                <div onClick={() => {
                                    this.toggleMobileFilter()
                                }} className="sidebar__header-mobile_btn __filter"/>
                            </div>
                        </div>
                    </div>
                ...
                <div className="sidebar__footer dt-hidden">
                    <div className="sidebar__button active button-submenu"><a href="/orders"
                                                                              className="sidebar__button-icon copy"/>
                        <div className="sidebar__button-label">Заявки</div>
                    </div>
                    <div className="sidebar__button button-submenu">
                        <div className="sidebar__button-icon charts"/>
                        <div className="sidebar__button-label">Отчеты</div>
                    </div>
                    <div className="sidebar__button button-submenu">
                        <div className="sidebar__button-icon avatar">
