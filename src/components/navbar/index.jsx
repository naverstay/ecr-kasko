				...
				<div className="sidebar__header">
					<div className="sidebar__button-wrapper">
						<div className="sidebar__button label-nohover">
							...
							<div className="sidebar__button-label label-nohover sidebar__fix-wrapper">
						...
						<div className="sidebar__button button-submenu">
							<a href="/" className="sidebar__button-icon add"></a>
							...
							<div className="sidebar__button-label">
								<div className="sidebar__search">
									<div className="sidebar__search-form"><input className="sidebar__search-input"
										...
										<button className="sidebar__search-button"></button></div>
						...
						<div className="sidebar__button button-submenu">
							...
							<div className="sidebar__button-label">
								<div className="sidebar__user">
									...
									<div className="sidebar__user-role">Менеджер по продажам<br/>ДЦ Дружба</div>
								</div>
							</div>
						</div>
						<div className="sidebar__button">
