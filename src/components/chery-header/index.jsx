                ...
                <div className="stick">
                    <div className="top" style={{opacity: '1'}}>
                        ...
                        <nav className="hidden-md visible-lg nav_1_mobile topcat" style={{display: 'none'}}>
                            ...
                            <a href="https://www.chery.ru/shop_search">СHERY ОНЛАЙН<br
                                className="hidden-md"/> спецпредложение</a>
                ...
                <div className="navigation">
                    <nav className="hidden-md visible-lg nav_2_mobile" style={{display: 'none'}}>
                            ...
                            <div className="row">
                                <div className="range">
                                    ...
                                    <div className="models-items">
                                        <div>
                                            <a className="models-items-link" href="https://tiggo8.chery.ru/"
                                               target="_blank">
                                            ...
                                            <a className="models-items-button" href="/shop_search">Автомобили в
                                                наличии</a>
                                        </div>
                                        <div>
						...
						руб.</span>
                                    ...
                                    <div className="notes">
                                        <p>*Показатели расхода топлива определены в соответствии с Правилами ЕЭК ООН №
                                            101</p>
                        ...
                        <div className="models_open mobile_list hidden-lg-i" style={{display: 'none'}}>
                            <a href="https://tiggo8.chery.ru/">Tiggo 8</a> <a href="/models/tiggo7">Tiggo 7</a> <a
                            href="/models/tiggo5new">Tiggo
                        ...
                        <div className="mileage_open hidden-md-i" style={{display: 'none'}}>
                            <div className="row">
                                <a className="one trade-in" href="/trade_in"><p className="h2">Chery Trade-in</p>
                                    <p>Оцените ваш автомобиль <br
                                        className="hidden-md"/>ОНЛАЙН</p>
                                    <div>Подробнее<br className="hidden-md"/> о программе обмена</div>
                                </a><a className="one offers" href="https://www.chery.ru/shop_search"><p
                                className="h2">Специальные предложения</p>
                            ...
                            </a><a className="one assess correctprice" href="https://www.chery.ru/shop_search"><p
                                className="h2">Онлайн бронирование</p>
                            ...
                            </a><a className="one coorporate" href="/corporate_sales"><p className="h2">Корпоративные
                                продажи</p><p>Особый подход<br
                                className="hidden-md"/> к вашему бизнесу</p>
                                <div>Подробнее<br className="hidden-md"/> о корпоративных продажах</div>
                            </a><a className="one cloudrive" href="/cloudrive"><p className="h2">Технология
                                CLOUDRIVE</p><p>Управление автомобилем <br
                        ...
                        <div className="mileage_open mobile_list hidden-lg-i" style={{display: 'none'}}>
                            <a href="/trade_in" className="trade-in">Chery Trade-in</a><a
                            href="https://www.chery.ru/shop_search" className="offers">Специальные
                            предложения</a><a href="https://www.chery.ru/shop_search" className="assess correctprice">Онлайн
                            бронирование</a><a
                            href="/corporate_sales" className="coorporate">Корпоративные продажи</a><a href="/cloudrive"
                                                                                                       className="cloudrive">Технология
                            CLOUDRIVE</a> <a href="javascript:void(0)" className="correctprice">Оцените ваш
                            автомобиль</a>
                        </div>
                            ...
                            <div className="container">
                                <div className="row">
                                    <a className="one" href="/creditonline">
                                        <div className="more inline">Получить кредит <br className="hidden-md"/>ОНЛАЙН
                                        </div>
                        ...
                        <div className="finance_open mobile_list hidden-lg-i" style={{display: 'none'}}>
                            <a href="/creditonline">Получить кредит <br className="hidden-md"/>ОНЛАЙН</a><a
                            href="/finance">Программы CHERY
                            ...
                            <div className="container">
                                <div className="row">
                                    <a className="one" href="/about">
                                        <div className="image"><img src="/images/navigation/about.jpg"
                                                                    alt="О компании"/></div>
                                    ...
                                    <div className="image"><img src="/images/navigation/publications.jpg"
                                                                alt="СМИ и блогеры о нас"/></div>
                                    <div className="more inline">СМИ и блогеры о нас</div>
                                </a><a className="one" href="/press/social">
                                    <div className="image"><img src="/images/navigation/social.jpg"
                                                                alt="Мы в соцсетях"/></div>
                                    <div className="more inline">Мы в соцсетях</div>
                                </a><a className="one" href="/customer_support">
                                    <div className="image"><img src="/images/navigation/support.jpg"
                                                                alt="Клиентская поддержка"/></div>
                                    <div className="more inline">Клиентская поддержка</div>
                                </a><a className="one" href="/contacts">
                                    <div className="image"><img src="/images/navigation/contacts.jpg" alt="Контакты"/>
                                    </div>
                        ...
                        <div className="world_open mobile_list hidden-lg-i" style={{display: 'none'}}>
                            <a href="/about">О компании</a><a href="/press">Новости</a><a href="/press/publications">СМИ
                            и блогеры о нас</a><a
                        ...
                        <div className="services_open mobile_list hidden-lg-i" style={{display: 'none'}}>
                            <a href="/service/chery_guarantee">Гарантия Chery</a><a href="/service/help">Программа
                            «Помощь в пути»</a><a
                            href="/service/original_access">Оригинальные аксессуары</a><a href="/oil">Chery Oil</a>
                        </div>
