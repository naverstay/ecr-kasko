        ...
        return (
            <div className="calculation-offers">
                ...
                <table className="calculation-offers__table">
                    <thead>
                    <tr>
                        <th className={"calculation-offers__table--col-1" + (osago ? " wide" : "") + ((completed || waiting) ? " small" : "")}>Страховая
                            компания
                        </th>
                        {!osago ?
                            <th className={(franchise ? "calculation-offers__table--col-10" : "calculation-offers__table--col-2") + ((completed || waiting) ? " small" : "")}>Тариф</th> : ""}
                        {(!osago && franchise) ?
                            <th className={"calculation-offers__table--col-9" + ((completed || waiting) ? " small" : "")}>Франшиза</th> : null}
