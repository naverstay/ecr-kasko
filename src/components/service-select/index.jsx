			...
			<>
				...
				{this.state.calculationPopupOpened ?
					<PopupOverlay span={16}>
						<ServicePopup popupCallback={this.updatePaymentState} osago={osago} step={step} allFields={false} fullCalculation={this.state.showCalculationOffers || this.state.fullCalculation} popupCloseFunc={this.toggleCalculationPopup} />
					</PopupOverlay>
					: null
				}
			</>
