        ...
        return (
            <div className="driver-info">
                ...
                <Row className="kasko-car-select__controls" gutter={20}>
                    ...
                    <Col span={6}>
                        <Input
                            className={"w_100p input-error custom_placeholder " + ((this.state.carPTS + '').length ? "" : " _empty")}
                ...
                <Row className="kasko-car-select__controls" gutter={20}>
                    ...
                    <Col span={12}>
                        <Input
                            className={"w_100p input-error custom_placeholder " + ((this.state.clientLicenseDepID + '').length ? "" : " _empty")}
                ...
                <Row className="kasko-car-select__controls" gutter={20}>
                    <Col span={24}>
                        <Input
                            className={"w_100p input-error custom_placeholder " + ((this.state.clientLicenseDepartment + '').length ? "" : " _empty")}
                ...
                <Row className="kasko-car-select__controls" gutter={20}>
                    <Col span={20}>
                        <Input
                            className={"w_100p input-error custom_placeholder " + ((this.state.clientAddress + '').length ? "" : " _empty")}
