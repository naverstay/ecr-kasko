                ...
                <div className={className} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} onClick={onClick}>
                        ...
                        {this.state.settingsOpen ?
                            <div ref={this.setWrapperRef} className="chat-title__menu">
                                <ul className="chat-title__menu--list">
                                    <li className="chat-title__menu--item check_v4"><Checkbox>Сортировать по
                                        времени</Checkbox></li>
                                    <li className="chat-title__menu--item check_v4"><Checkbox>Сортировать по
                                        прочитанному</Checkbox></li>
                                    <li className="chat-title__menu--item chat-title__menu--split">Пометить все как
                                        прочитанное
                                    </li>
                    ...
                    <div className="chat-scroller">
                        {data.map((d, i) => {
                            ...
                            return <ChatDay key={i} classDay={classDay} classCaption={classCaption} msg={d.msg}
