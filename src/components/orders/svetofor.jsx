			...
			<div className={className}>
				{data.map((s, i) => {
					...
					return (
							...
							<div key={i} className="orders-table__tooltip-holder">
								...
								<div className="orders-table__tooltip orders-table__tooltip--top">
									<ul className="orders-table__tooltip-list">
										<li>
											<div className={"orders-table__state orders-table__state" + status}>{s.tooltipTitle}</div>
						...
						: s.tooltipShort ?
							<Tooltip key={i} overlayClassName={tooltipClassName} placement="top" title={s.tooltipTitle}>
								<span className={cls}>{s.value || ''}</span>
							</Tooltip>
