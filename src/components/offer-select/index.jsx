                ...
                <div className="kasko-car-select">
                    ...
                    {step === 3 ?
                        <>
                            ...
                            <CalculationOffers osago={osago} completed={true} selectedOffer={this.updateSelectedOffer}
                                               offersList={[
                                                   {
                                                       logo: './logo/bck.png',
                                                       offers: [
                            ...
                            <KaskoOffers step={step} active={[(osago ? 0 : 1)]} completed={[(osago ? 0 : 1)]}
                                         offersList={osago ?
                                             [
                                                 {
                                                     name: 'е-ОСАГО',
                                    ...
                                    {(!this.state.showCalculationOffers || this.state.openParams || osago) ?
                                        <>
                                            {!osago ?
                                                <>
                                                    <div
                                                        className="kasko-car-select__controls radio_v2 wide_group mb_0">
                                                        ...
                                                        <Radio.Group defaultValue={this.state.hasFranchise ? 1 : 0}
                                                            ...
                                                            <Row gutter={20}>
                                                                ...
                                                                {this.state.hasFranchise ?
                                                                    <Col
                                                                        className={"kasko-car-select__controls--flex-1"}>
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <Col>
                                                                            <div className="kasko-offer__more">
                                                                                <div
                                                                                    onClick={this.onShowMoreDamagesChange}
                                                        ...
                                                        <>
                                                            {!osago ?
                                                                <div
                                                                    ...
                                                                    <span
                                                                        className="kasko-car-select__calculation--text">Предварительный расчет</span>
                                                                    ...
                                                                    <span
                                                                        className="kasko-car-select__calculation--text">Окончательный расчет</span>
                                                                </div>
                                                                : null
                                                            }
                            ...
                            {this.state.showCalculationOffers ?
                                <>
                                    <CalculationOffers franchise={this.state.hasFranchise}
                                                       allowCheck={this.state.showPayment || osago || popup}
                                         ...
                                         className={"kasko-car-select__controls ant-row-center align_center"}>
                                        {
                                            (step === 2) ?
                                                ...
                                                popup ?
                                                    <>
                                                        <Col span={12}>
                                                            <Button htmlType="submit"
                                                                    ...
                                                                    onClick={this.addToCredit}>Добавить в
                                                                кредит</Button>
                                                        </Col>
                                                        <Col span={24}/>
                                                        <Col span={12}>
                                                    ...
                                                    <>
                                                        <Col span={6}>
                                                            <Link to="/credit_kasko" className={"w_100p ant-btn"}>Отказ
                                                                клиента</Link>
                                                        </Col>
                                                        <Col span={12}>
                                                            <Button htmlType="submit"
                                                        ...
                                                        <Col span={6}>
                                                            <Link to="/credit_kasko" className={"w_100p ant-btn"}>Добавить
                                                                в кредит</Link>
                                                        </Col>
                                                    </>
