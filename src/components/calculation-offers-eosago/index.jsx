...
class CalculationOffersEosago extends Component {
    ...
    render() {
        ...
        const sortTypeList = ['Сортировать по самому выгодному е-КАСКО+е-ОСАГО', 'Сортировать по самому выгодному е-КАСКО', 'Сортировать по самому выгодному GAP', 'Сортировать по самому выгодному е-ОСАГО']
                    ...
                    {refused ?
                        ...
                        <tr>
                            <td style={{height: '86px'}} colSpan={5}>
                                <p className={'text_center fz_20 fw_500'}>Клиент отказался от страхования е-ОСАГО</p>
                            </td>
                        </tr>
                        </tbody>
                        : null}
