        ...
        return (
            <div className="kasko-car-select">
                ...
                <div className="credit-slider__wrapper">
                    <Row
                        className={"kasko-car-select__controls car-credit" + (this.state.showCarOptions ? " mt_15" : "")}
                        gutter={20}>
                        <Col span={10}>
                ...
                <div onClick={this.toggleShowParams}
                     className={"kasko-car-select__caption" + (this.state.openParams ? " expanded" : " collapsed")}>Параметры
                    кредита
                </div>
