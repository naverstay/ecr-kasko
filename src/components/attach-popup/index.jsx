	...
	render() {
		...
		return (
			<div className="kaskotax-popup attach-popup">
				...
				<div className={"kaskotax-popup__title" + (subtitle && subtitle.length ? ' mb_10' : '')}>Загрузить и распознать документы</div>
				...
				<Form ref={this.formRef} name="control-ref" onFinish={this.onFinish}>
					...
					<Row className="kasko-car-select__controls ant-row-center mb_0" gutter={20}>
						<Col span={5}>
							<Button htmlType={formDisabled ? null : "submit"} className={"w_100p ant-btn btn_green"}>Отправить</Button>
						</Col>
					</Row>
				</Form>
			</div>
