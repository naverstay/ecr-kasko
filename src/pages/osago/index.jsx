            ...
            <>
                <Row gutter={20} className="kasko-wrapper">
                    ...
                    <Col span={16} className="kasko-main">
                        <OfferSelect osago={true} imageCallback={this.imageCallback} step={step}
                ...
                <Row gutter={20} className="kasko-wrapper kasko-wrapper__fixed">
                    <Col span={4} className="kasko-aside">
                        ...
                        <AsideBlock>
                            <KaskoCarInfo osago={true} step={step}
                                          notificationCount={step === 2 ? 1 : step === 3 ? 2 : 0}
                                          carName={step === 1 ? '' : 'Hyundai'} carModel={step === 1 ? '' : 'Sonata'}
                    ...
                    <Col span={4} className="kasko-aside">
                        {showOffers === false ?
                            ...
                            :
                            <AsideBlock>
                                <KaskoNotices osago={true} step={step}
